...
example : addOrderOf (1 : ℤ) = 0 := by
  ...
  intros n n0
  refine Int.natAbs_pos.mp ?_ 
  simp only [nsmul_eq_mul, mul_one, Int.natAbs_ofNat]
  assumption
  done 
